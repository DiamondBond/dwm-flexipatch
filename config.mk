...
CFLAGS   = -std=c99 -pedantic -Wall -Wno-unused-function -Wno-deprecated-declarations -O3 -mtune=native -march=native -fomit-frame-pointer -flto -fno-semantic-interposition ${INCS} ${CPPFLAGS}
LDFLAGS  = ${LIBS}
